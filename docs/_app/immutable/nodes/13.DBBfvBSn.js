import{s as W,e as r,a as o,c as m,r as w,g as u,b as B,f as b,m as c,i as F,h as a}from"../chunks/scheduler.C5oQXhGe.js";import{S as X,i as Z,c as y,b as C,m as j,t as N,a as q,d as I}from"../chunks/index.BeDZARuC.js";import{j as ee,L as te}from"../chunks/javascript.Y6sO4_44.js";import{b as Q}from"../chunks/bash.CiiqfXL8.js";import{H}from"../chunks/Highlight.DZSFdoca.js";function se(T){let n,p;return n=new te({props:{highlighted:T[0]}}),{c(){y(n.$$.fragment)},l(l){C(n.$$.fragment,l)},m(l,e){j(n,l,e),p=!0},p(l,e){const i={};e&1&&(i.highlighted=l[0]),n.$set(i)},i(l){p||(N(n.$$.fragment,l),p=!0)},o(l){q(n.$$.fragment,l),p=!1},d(l){I(n,l)}}}function ne(T){let n,p="Frontend számonkérés: Céges leltárptogram implementációja",l,e,i,U='<span>1. feladat: </span>Projekt létrehozása, config beállítása, projekt elindítása, <a href="https://cdnjs.com/libraries/semantic-ui" target="_blank">ui beállítása</a>, projekt publikálása.',L,g,V,h,Y="2. feladat: Adatstruktúra és adatbázis létrehozása.",K,M,S,f,k,d,A,v,E,$,G="3. Projekt elindítása fejlesztés közbeni teszteléshez.",P,x,R,z,J=`4. További önálló feladatok:<ul class="svelte-1nw82x9"><li class="svelte-1nw82x9">menü készítése, Regisztrációs űrlap szükséges módosítása a <a href="https://github.com/tomuwhu/szamonkeres">(minta)</a> szerint,</li><li class="svelte-1nw82x9">CRUD alkalmazás készítése az eszközök felviteléhez és userek hozzárendeléséhez,</li><li class="svelte-1nw82x9">különböző nézetek készítése: 
