...
Például termék törléséhez a webshopból a DELETE metódust használják.</td></tr></table>`,R,$,X='<img class="ra svelte-9tnb45" src="/frontend2425/rest-api.png" alt="REST API"/>',q,b,Y="Kezdeti adatok lekérdezése a szerverről (GET metódus):<br/>",U,E,L,g,N,_,Z="Adat küldése szerverre: POST (PUT, PATCH, DELETE) metódus:<br/>",G,z,H,h,J,k,ee="Express Server API:<br/>",K,D,I,u,O;return g=new W({props:{language:B,code:`//App.js <script></sript> -be:
